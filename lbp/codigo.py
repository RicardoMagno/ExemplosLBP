...
class LBP:
	...
	def calculates_x_coordinate(self, xc, r, p, P):
		cos = math.cos(math.pi*((2*p)/P))
		if (cos>0): cos = math.ceil(cos)
		elif(cos<0): cos = math.floor(cos)
		return (xc + (r*cos))
	
	# metodo para calcular a coordenada y		
	def calculates_y_coordinate(self, yc, r, p, P):
		sin = math.sin(math.pi*((2*p)/P))
		if (sin>0): sin = math.ceil(sin)
		elif(sin<0): sin = math.floor(sin)
...
if __name__=="__main__":
	imgName = '/home/mainara/projeto_eeg/jaffeimages/jaffe/KA.AN1.39.tiff'
