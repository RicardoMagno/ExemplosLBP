...
class UT_LBP(unittest.TestCase):
    ...
    def test_calculates_x_coordinate(self):
        ...
        x3 = xc
        x4 = xc - 1
        x_viz1 = lbp.calculates_x_coordinate(xc, r, 1, P)
        x_viz2 = lbp.calculates_x_coordinate(xc, r, 4, P)
        x_viz3 = lbp.calculates_x_coordinate(xc, r, 3, P)
        x_viz4 = lbp.calculates_x_coordinate(xc, r, 2, P)
    ...
    def testPAcimaDoLimite(self):
        imgName = 'testarAoRedor.png'
        img1 = scipy.misc.imread(imgName, flatten=True)
        lbp = LBP()
        self.assertRaises(lbp.LBPOutOfRangeError, computeLBP, img1, 16, 1)
    ...
    def test_calculates_y_coordinate(self):
        # calculates_y_coordinate(self, yc, r, p, P)
        lbp = LBP()
        yc = 2
        r = 1
        pixel = 1
        ...
        y_viz1 = lbp.calculates_y_coordinate(yc, r, 1, P)
        y_viz2 = lbp.calculates_y_coordinate(yc, r, 4, P)
        y_viz3 = lbp.calculates_y_coordinate(yc, r, 3, P)
        y_viz4 = lbp.calculates_y_coordinate(yc, r, 2, P)
